...
Material.effectiveness  = 0.05
Material.resiliance	= 50

Material.spallarmor	= 0.1
Material.spallresist	= 5

Material.spallmult	= 0.2
Material.ArmorMul	= 1
Material.NormMult	= 1
