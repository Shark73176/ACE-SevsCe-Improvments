...
Material.sname		= "Concrete"
Material.desc		= "Another material that while useless against kinetic rounds, excels at stopping shaped charges and spall"
Material.year		= 1940

Material.massMod		= 0.32
Material.curve		= 1


Material.effectiveness  = 0.35 --Kinetic effectiveness. What sociopath builds a tank out of rubber?
Material.resiliance	= 1.2 --Resiliance against penetrating kinetic shells
Material.Catchresiliance = 0.8 --Resiliance Multiplier used for kinetic shells when they fail to penetrate the armor and are "caught"


Material.HEATeffectiveness = 0.35
Material.HEATresiliance = 1.2

Material.HEresiliance	= 2


Material.spallarmor	= 1
Material.spallresiliance = 2

Material.spallmult	= 0.2 --While spall can pierce rubber, Rubber itself should not really spall.
Material.ArmorMul	= 1
Material.NormMult	= 1
