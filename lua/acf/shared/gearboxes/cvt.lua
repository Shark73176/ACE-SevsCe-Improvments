...
ACF_DefineGearbox( "CVT-ST-L", {
 ...
 ACF_DefineGearbox( "MCVT-ST-L", {
	name = "MCVT, Straight, LargeAlt",
	desc = "Mega CTV for Sweden diesel and hybrid" .. CVTDesc,
	model = "models/engines/t5large.mdl",
	category = "CVT",
	weight = math.floor(GearCVTLW * StWB),
	switch = 0.3,
	maxtq = math.floor(GearCVTLMT * StTB),
	gears = 2,
	cvt = true,
	geartable = {
		[-3] = 3000, --target min rpm
 ...
 ACF_DefineGearbox( "M2CVT-ST-L", {
	name = "MCVT, Straight, LargeAlt2",
	desc = "Mega CTV for Sweden diesel and hybrid" .. CVTDesc,
	model = "models/engines/t5large.mdl",
	category = "CVT",
	weight = math.floor(GearCVTLW * StWB),
	switch = 0.3,
	maxtq = math.floor(GearCVTLMT * StTB * 2),
	gears = 2,
	cvt = true,
	geartable = {
		[-3] = 3000, --target min rpm
