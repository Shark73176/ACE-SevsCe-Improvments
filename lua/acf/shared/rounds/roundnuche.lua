...
ACF.AmmoBlacklist.NUCHE = { "MG", "SL", "ECM","ATR" }

local Round = {}

Round.type  = "Ammo" --Tells the spawn menu what entity to spawn
Round.name  = "[NUCHE] - " .. ACFTranslation.ShellNUCHE[1] --Human readable name
Round.model = "models/munitions/round_100mm_shot.mdl" --Shell flight model
Round.desc  = ACFTranslation.ShellNUCHE[2]
Round.netid = 40 --Unique ammotype ID for network transmission
...
function Round.network( Crate, BulletData )
	...
	Crate:SetNWString( "AmmoType", "NUCHE" )
...
function Round.guicreate( Panel, Table )
	...
	acfmenupanel:AmmoSlider("FillerVol",0,0,100000,3, "HE Filler", "")			--Slider (Name, Value, Min, Max, Decimals, Title, Desc)
...
list.Set("HERoundTypes", "NUCHE", Round ) --Set the round on chemical folder
