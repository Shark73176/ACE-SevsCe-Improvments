...
ACF.AmmoBlacklist.FUAPFSDS = { "AC", "SA","C","MG", "HMG" ,"RAC", "SC","ATR" , "MO" , "RM", "SL", "GL", "HW", "SC", "BOMB" , "GBU", "ASM", "AAM", "SAM", "UAR", "POD", "FFAR", "ATGM", "ARTY", "ECM", "FGL"}

local Round = {}

Round.type  = "Ammo" --Tells the spawn menu what entity to spawn
Round.name  = "[FUAPFSDS] - " .. ACFTranslation.ShellFUAPFSDS[1] --Human readable name
Round.model = "models/munitions/dart_100mm.mdl" --Shell flight model
Round.desc  = ACFTranslation.ShellFUAPFSDS[2]
...
function Round.convert( _, PlayerData )
	...
	Data.MinCalMult		= 0.2
	Data.MaxCalMult		= 1.0
	Data.PenModifier		= 0.75 --for 120mm. 726 @ 1.1. 630 @1.3
	Data.VelModifier		= 1.05
	Data.Ricochet		= 80

	--Used for adapting acf2 apds/FUAPFSDS to the new format
...
function Round.network( Crate, BulletData )
	...
	Crate:SetNWString( "AmmoType", "FUAPFSDS" )
...
function Round.guicreate( Panel, Table )
	...
	acfmenupanel:AmmoSelect( ACF.AmmoBlacklist.FUAPFSDS )
...
function Round.guiupdate( Panel )
	...
	local PlayerData = {}
		...
		PlayerData.Type = "FUAPFSDS"									--Hardcoded, match as Round.Type instead
...
list.Set( "APFSDSRoundTypes", "FUAPFSDS", Round )
