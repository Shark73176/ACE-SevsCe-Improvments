...
ACF_defineGun("200mmSC", {
	name = "200mm Short Cannon",
	desc = "Interesting and big gun, but why it's short.(You should resize model by propresizer 2x!)",
	model = "models/tankgun/tankgun_short_100mm.mdl",
	sound = "ace_weapons/multi_sound/120mm_multi.mp3",
	gunclass = "SC",
	caliber = 20.0,
	weight = 4400 / 8,
	maxrof = 4.4, -- maximum rounds per minute
	year = 1999,
	round = {
		maxlength = 170,
		propweight = 17
