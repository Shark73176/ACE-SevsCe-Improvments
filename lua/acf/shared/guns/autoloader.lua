...
ACF_defineGun("200mmAL", {
	name = "200mm Autoloading Cannon",
	desc = "The 200mm can shred an average.... Average tank? Maybe an average monster tank. (You should resize model by propresizer 2x! )",
	model = "models/tankgun/tankgun_al_100mm.mdl",
	sound = "ace_weapons/multi_sound/120mm_multi.mp3",
	autosound = "acf_extra/tankfx/reload.wav",
	gunclass = "AL",
