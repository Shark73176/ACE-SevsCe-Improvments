...
function ENT:Initialize()
	...
	local rareNames = {"Mr.Marty", "RDC", "Cheezus", "KemGus", "Golem Man", "Arend", "Mac", "Firstgamerable", "kerbal cadet", "Psycho Dog", "Ferv", "Rice", "spEAM", "Nikv", "Blodegore", "Shark731"}
...
function ENT:DecreaseStamina()
	...
	if IsValid(linkedGun) then
		...
		local staminaCost = (5 + staminaMultipliers)*0 -- take x points out of self.Stamina
