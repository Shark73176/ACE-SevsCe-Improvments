...
if SERVER then
	...
	--Sbox Limits
	CreateConVar("sbox_max_acf_gun", 64)					-- Gun limit
	CreateConVar("sbox_max_acf_rapidgun", 24)				-- Guns like RACs, MGs, and ACs
	CreateConVar("sbox_max_acf_largegun", 24)				-- Guns with a caliber above 100mm
	...
	CreateConVar("sbox_max_acf_rack", 40)					-- Racks limit

	CreateConVar("acf_mines_max", 100)						-- The mine limit
